...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 484, .adv_w = 672, .box_w = 42, .box_h = 48, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 736, .adv_w = 960, .box_w = 60, .box_h = 36, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1006, .adv_w = 768, .box_w = 48, .box_h = 42, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1258, .adv_w = 672, .box_w = 42, .box_h = 48, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 1510, .adv_w = 672, .box_w = 42, .box_h = 48, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 1762, .adv_w = 672, .box_w = 39, .box_h = 48, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 1996, .adv_w = 768, .box_w = 48, .box_h = 42, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 2248, .adv_w = 960, .box_w = 60, .box_h = 42, .ofs_x = 0, .ofs_y = -3}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x1, 0x28, 0x2e, 0x116, 0x227, 0x229, 0x2a7,
    0x3c5, 0x7f3
};
